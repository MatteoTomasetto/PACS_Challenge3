...
public:
	...
	template<NormType normtype = FROBENIUS >//,enable_if_v< std::is_convertible<Scalar, double> >>
	double norm() const; 
...
private:
	...
	bool						compressed_{false}; // bool to understand which representation is used
};
